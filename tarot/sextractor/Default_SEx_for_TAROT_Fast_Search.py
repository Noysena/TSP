...
#------------------------------- Extraction ----------------------------------
         ...
         'DETECT_MINAREA'   : '10.0',    # TCA TCH 5.0 TRE 7.0 minimum number of pixels above threshold
         'DETECT_THRESH'    : '5.0',    # TCA TCH 3.0 TRE 5.0 Tuse '1.5' or '23.2,25.0',    # <sigmas> or <threshold>,<ZP> in mag.arcsec-2
         'ANALYSIS_THRESH'  : '5.0',    # TCA TCH 2.0 TRE 3.0sigmas> or <threshold>,<ZP> in mag.arcsec-2
...
#------------------------------ Photometry -----------------------------------
        'PHOT_APERTURES'    : '15',       # MAG_APER aperture diameter(s) in pixels; normal set to 5
        'PHOT_AUTOPARAMS'   : '5.0, 10.0',# MAG_AUTO parameters: <Kron_fact>,<min_radius> '2.5, 3.5'
        'PHOT_PETROPARAMS'  : '5.0, 10.0',# MAG_PETRO parameters: <Petrosian_fact>, <min_radius> '2.5, 3.5'
        'SATUR_LEVEL'       : '55930.0', # level (in ADUs) at which arises saturation
...
#------------------------------- Extraction ----------------------------------
         'DETECT_TYPE'      : 'CCD',  # CCD (linear) or PHOTO (with gamma correction)
         'DETECT_MINAREA'   : '10.0',  # TRE 7.0 minimum number of pixels above threshold
         'DETECT_THRESH'    : '5.0',  # TRE 5.0 Tuse '1.5' or '23.2,25.0',    # <sigmas> or <threshold>,<ZP> in mag.arcsec-2
         'ANALYSIS_THRESH'  : '5.0',  # TRE 3.0sigmas> or <threshold>,<ZP> in mag.arcsec-2
         'FILTER'           : 'Y',    # apply filter for detection (Y or N)?
         'FILTER_NAME'      : '/usr/share/sextractor/gauss_1.5_3x3.conv',   # name of the file containing the filter
         'DEBLEND_NTHRESH'  : '32',   # Number of deblending sub-thresholds
         'DEBLEND_MINCONT'  : '0.005',# Minimum contrast parameter for deblending
